...
- Dependent tests apply (`rules/build-and-test.md`, section "Dependent tests"): they confirm that a change here doesn't break the projects that use `hetu-util-java` and has the intended effect in them.
  - Dependent library: `hetu-validation-java` (`rules/repositories.md`).
  - Default dependent: [hetu-validation-java](https://github.com/ishtech/hetu-validation-java).
  - `hetu-util-java` is public on Maven Central, so it may have other dependents that nobody can list.
